...
void renderStart1(SDL_Renderer *sdlRenderer, SDL_bool *shallExit, bool start[], TTF_Font *font, char text[])
{
    ...
    char text1[] = "Username:";
    boxColor(sdlRenderer, rect[3].x1, rect[3].y1, rect[3].x2, rect[3].y2, color[1]);
    renderLabelMenu(sdlRenderer, rect[3], text1, font);
...
void renderStart2(SDL_Renderer *sdlRenderer, Map *map, SDL_bool *shallExit, bool start[], TTF_Font *font, int *number_of_players, int *number_of_blocks, Uint32 regionColor[], Uint32 sarbazkhuneColor[], struct Potion potion[], int *seed)
{
    ...
    Uint32 color[2] = {0xff0000ff, 0xffffffff};
    SDL_Event sdlEvent;
    ...
    char text2[] = "Number of players:";
    boxColor(sdlRenderer, boxrect[3].x1, boxrect[3].y1, boxrect[3].x2, boxrect[3].y2, color[1]);
    renderLabelMenu(sdlRenderer, boxrect[3], text2, font);
    char text3[] = "Number of blocks:";
    boxColor(sdlRenderer, boxrect[4].x1, boxrect[4].y1, boxrect[4].x2, boxrect[4].y2, color[1]);
    renderLabelMenu(sdlRenderer, boxrect[4], text3, font);
    while (SDL_PollEvent(&sdlEvent))
    {
        switch (sdlEvent.type)
        {
